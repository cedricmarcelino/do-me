class TasksController < ApplicationController
  ...
  before_action :set_category, :set_user, :authenticate_user!, only: [:index,:create,:show]
  ...
  def create
    ...
    if @task.save
      redirect_to user_category_tasks_path(user_id: current_user.id, category_id: @task.category_id)
    else
      render :index
    end
  end
